            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="<?= base_url('admin/staff-management/add') ?>" class="btn btn-primary">Add New Staff</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($member['image_path']): ?>
                                                <img src="<?= base_url($member['image_path']) ?>" alt="<?= $member['name'] ?>" style="max-width: 100px;">
                                            <?php else: ?>
                                                No Image
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <a href="<?= base_url('admin/staff-management/delete/' . $member['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
