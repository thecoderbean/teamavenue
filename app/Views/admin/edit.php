...
<head>
    ...
    <title>TeamAvenues.com - Edit Blog</title>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php endif; ?>
                        <form action="<?= base_url('admin/blog-management/update/' . $blog['id']) ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-group mb-3">
                                <label for="title">Blog Title</label>
                                <input type="text" name="title" id="title" class="form-control" placeholder="Enter Blog Title" value="<?= esc($blog['title']) ?>" required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="content">Content</label>
                                <textarea name="content" id="content" rows="5" class="form-control" placeholder="Write your blog content here..." required><?= esc($blog['content']) ?></textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label for="thumbnail">Thumbnail Image</label>
                                <?php if ($blog['thumbnail']): ?>
                                    <img src="<?= base_url('uploads/blogs/' . $blog['thumbnail']) ?>" alt="Thumbnail" width="200" class="mb-2">
                                <?php endif; ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="url" name="featured_video" id="featured_video" class="form-control" placeholder="https://youtube.com/yourvideo" value="<?= esc($blog['featured_video']) ?>">
                            </div>
